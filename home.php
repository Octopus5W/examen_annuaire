...
<div class="max-w-xl mx-auto px-4 sm:px-6 flex flex-col gap-3 bg-gray-200 justify-between items-center h-screen">
    ...
    <div class="flex justify-between gap-3 w-full">
        <a class="block bg-gray-300 hover:bg-gray-200 rounded-lg h-12 w-1/2 text-center py-3" href="register.php">S'inscrire</a>
        <a class="block bg-gray-300 hover:bg-gray-200 rounded-lg h-12 w-1/2 text-center py-3" href="login.php">Se connecter</a>
    </div>
</div>
