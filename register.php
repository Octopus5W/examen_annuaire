...
<form class="flex flex-col gap-2 justify-between h-screen" action="?action=register" method="post">
    <div>
        <div class="flex flex-col">
            <label class=" px-2" for="firstname">Prénom</label>
            <input class=" rounded-lg h-16 px-2" type="firstname" name="firstname" id="firstname" placeholder="Prénom" required>
        ...
        <div class="flex flex-col">
            ...
            <input class=" rounded-lg h-16 px-2" type="lastname" name="lastname" id="lastname" placeholder="Nom" required>
        ...
        <div class="flex flex-col">
            ...
            <input class=" rounded-lg h-16 px-2" type="username" name="username" id="username" placeholder="Nom d'utilisateur" required>
        ...
        <div class="flex flex-col">
            ...
            <input class=" rounded-lg h-16 px-2" type="password" name="password" id="password" placeholder="Mot de passe" required>
        ...
        <div class="flex flex-col">
            ...
            <input class=" rounded-lg h-16 px-2" type="password" name="password_confirmation" id="password_confirmation" placeholder="Mot de passe" required>
        ...
        <div class="flex flex-col">
            ...
            <input class=" rounded-lg h-16 px-2" type="text" name="response" id="response" placeholder="Réponse" required>
    ...
    <div class="flex justify-between gap-2">
        <input class="block bg-gray-300 hover:bg-gray-200 rounded-lg h-16 w-1/2 text-center py-5" type="submit" value="S'inscrire">
        <a class="block bg-gray-300 hover:bg-gray-200 rounded-lg h-16 w-1/2 text-center py-5" href="home.php">Retour</a>
    </div>
