...
<form class="flex flex-col gap-3 justify-between h-screen" action="login.php?action=login" method="post">
    <div>
        <div class="flex flex-col">
            <label class=" px-2" for="username">Nom d'utilisateur</label>
            <input class="  rounded-lg h-12 px-2" type="username" name="username" id="username" placeholder="utilisateur" required>
        ...
        <?php if (!isset($_GET['forgot_password'])) : ?>
            ...
            <div class="flex flex-col">
                ...
                <input class="rounded-lg h-12 px-2" type="password" name="password" id="password" placeholder="******" required>
    ...
    <div class="flex items-center flex-col gap-3">
        <input class="bg-gray-300 hover:bg-gray-200 block 0 rounded-lg h-12 w-1/2" type="submit" value="Confirmer">
...
<?php else : ?>
    ...
    <div class="flex flex-col">
        ...
        <input class="rounded-lg h-12 px-2" type="text" name="response" id="response" placeholder="Réponse secrète" required>
    ...
    <div class="flex flex-col">
        ...
        <input class="rounded-lg h-12 px-2" type="password" name="new_password" id="new_password" placeholder="Nouveau mot de passe" required>
    ...
    <div class="flex flex-col">
        ...
        <input class="rounded-lg h-12 px-2" type="password" name="new_password_confirmation" id="new_password_confirmation" placeholder="Nouveau mot de passe" required>
    ...
    <div class="flex justify-between gap-3">
        <input class="block bg-gray-300 hover:bg-gray-200 rounded-lg h-12 w-1/2 text-center py-3" type="submit" value="Confirmer">
        <a class="block bg-gray-300 hover:bg-gray-200 rounded-lg h-12 w-1/2 text-center py-3" href="login.php">Annuler</a>
    </div>
<?php endif; ?>
</form>
